  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-semibold text-white mb-6 animate-fade-down">
        ...
        <p className="text-lg sm:text-xl text-white/90 mb-8 max-w-2xl mx-auto animate-fade-up">
